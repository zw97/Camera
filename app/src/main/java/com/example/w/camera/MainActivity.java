...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //拍照并保存到私有目录
        Button buttonSaveToPrivate=(Button)findViewById(R.id.buttonTakePhotoAndSaveToPrivate);
        //只有设备上有相机才能执行相机的有关操作
        if(!getPackageManager().hasSystemFeature(PackageManager.FEATURE_CAMERA)){
        ...
        buttonSaveToPrivate.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                Intent takePictureIntent=new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
                //Ensure taht there's a camera activity to handle the intent
                if(takePictureIntent.resolveActivity(getPackageManager())!=null){
                    //Create the File where the photo should go
                    File photoFile=null;
                    try{
